...
/* --- MyPost Widget allows users to post --- */
...
/* --- API CALLS --- */
  ...
  const handlePost = async () => {
      // creates form data for api call 'response'
...
/* --- RENDER UI --- */
  return (
    <WidgetWrapper>
            {/*User Picture & User Post Placeholder*/}
                ...
                >
                    ...
                    {({ getRootProps, getInputProps, isDragActive }) => (
                        <div {...getRootProps()} style={{ display: "inline-block" }} >
                            ...
                            <FlexBetween gap="0.25rem" sx={{ padding: "0.4rem 0.75rem", borderRadius: "0.5rem", backgroundColor: palette.neutral.light, cursor: "pointer", transition: "0.2s", "&:hover": { backgroundColor: palette.neutral.light }, opacity: isDragActive ? 0.7 : 1, }} >
                                <ImageOutlined sx={{ color: mediumMain }} />

                                    {/*Sets Image placeholder to filename*/}
